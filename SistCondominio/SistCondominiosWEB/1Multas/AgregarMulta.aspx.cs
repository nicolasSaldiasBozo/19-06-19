...
public partial class _1Multas_AgregarMulta : System.Web.UI.Page
{
    ...
    {
        Convert.ToInt32(txtDepartamento);

        conexion.Open();
        OracleCommand con = new OracleCommand("AGREGA_RESERVA_E", conexion);
        con.CommandType = System.Data.CommandType.StoredProcedure;
        con.Parameters.Add("departamento", OracleType.Int32).Value = txtDepartamento.Text;
        con.Parameters.Add("departamento", OracleType.VarChar).Value = txtDescripcion.Text;
        con.Parameters.Add("departamento", OracleType.VarChar).Value = txtMonto.Text;
