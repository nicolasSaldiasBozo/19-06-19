...
<body>
    ...
    <asp:TableRow>
            ...
            <asp:TableCell>
                 ...
                 <label  style="margin-left:15px">Tipo Reserva </label>
 ...
 <label  style="margin-left:56px">fecha Termino</label>
         ...
         <asp:TableRow Font-Italic="False">
           ...
           <div class="clearfix" align="center" id="fechaprueba" >
               <br />
               <asp:TextBox ID="fechauno" runat="server" TextMode="DateTimeLocal"></asp:TextBox>
               <asp:TextBox ID="fechados" runat="server" CssClass="auto-style6" TextMode="DateTimeLocal"></asp:TextBox>
               <br /><br />
