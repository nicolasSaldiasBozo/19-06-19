...
public partial class _0PaginaDeInicio_1Residente_MenuR : System.Web.UI.Page
{
    ...
    protected void btn_cosulta_reserva_Click(object sender, EventArgs e)
    {
        ...
        depa = depaInt.ToString();
         ...
         Response.Redirect("~/1CrearReserva/Reservas.aspx?nombre=" + nomb + "&departamento_id=" + depa + "&apellido=" + ape + "&correo=" + corr);
    ...
    protected void btn_info_pgo_g_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/1GastosComunes/GastosComunes.aspx?nombre=" + nomb + "&departamento_id=" + depa + "&apellido=" + ape + "&correo=" + corr);
    }
